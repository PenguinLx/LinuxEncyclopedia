   ...
   char fullPath[60];
        ...
        if (strcmp(getenv("LANG"), "pt_PT.UTF-8") == 0 || strcmp(getenv("LANG"), "pt_BR.UTF-8") == 0) {
            ...
            //o caminho muda para isso daqui
             ...
             //homedir e docdir sao escritos no fullpath com o tamanho maximo de 60 caracteres que é o tamanho do char fullpath
      ...
      char fullpath[100];
      char user_prof = getenv("USERPROFILE");
        printf("USERPROFILE = %s\n", getenv("USERPROFILE"));
    printf("HOMEDRIVE   = %s\n", getenv("HOMEDRIVE"));
    printf("HOMEPATH    = %s\n", getenv("HOMEPATH"));
    snprintf(fullPath,sizeof(fullPath), user_prof);
